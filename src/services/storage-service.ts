...
export class StorageService {
    ...
    public static save<T>(key: string, value: T): boolean {
        try {
          ...
          this.loggingService.error('Error saving to storage:', e);
            return false;
        }
    }
    ...
    public static load<T>(key: string, defaultValue: T | null = null): T | null {
        try {
          ...
          this.loggingService.error('Error loading from storage:', e);
            return defaultValue;
        }
    }
    ...
    public static remove(key: string): boolean {
        try {
          ...
          this.loggingService.error('Error removing from storage:', e);
            return false;
        }
    }
